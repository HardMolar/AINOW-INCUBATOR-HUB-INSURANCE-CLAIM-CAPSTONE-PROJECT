...
## 🚧 Data Exploratory Analysis
   * Distribution of target variables (Claim = 0/1).
     ...
     plt.show()
     ```
   <img width="794" height="445" alt="HD1" src="[https://github.com/user-attachments/assets/1958c2bb-6d8b-48a7-9ae9-ac7feea15dae](https://github.com/HardMolar/AINOW-INCUBATOR-HUB-INSURANCE-CLAIM-CAPSTONE-PROJECT/blob/9604f7e7e38381acf60732833983629734377e0a/Visuals/Distribution%20of%20Insurance%20Claims.png)" />
